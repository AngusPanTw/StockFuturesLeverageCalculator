...
2. **Apply Project Standards**: Follow the established coding standards including:
   ...
   **For Python:**
   ...
   - Prefer explicit function names over lambda expressions
   ...
   **For C#:**
   ...
   - Apply async/await patterns appropriately
   - Keep LINQ queries readable and maintainable
   - Use nullable reference types where applicable
   - Implement proper using statements and resource management
